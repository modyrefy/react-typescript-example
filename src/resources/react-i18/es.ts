export const TRANSLATIONS_ES={
  ...
  //Menu-Data
  "Routes.Home": "Home-es",
  "Routes.Login": "Login-es",
  "Routes.Signup": "Signup-es",
  "Routes.Products": "Products-es",
  "Routes.Common.Products": "Common-Products-es",
  "Routes.Private": "Private-es",
  "Routes.Public": "Public-es",
}
